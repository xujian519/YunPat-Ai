    ...
    public static func capabilities() -> [CapabilityDefinition] {
        [
            CapabilityDefinition(
                ...
                source: .plugin,
                permission: .always,
                metadata: CapabilityMetadata(costLevel: .low, requiresNetwork: true, isIdempotent: true, typicalUseCases: ["OA解析", "审查意见分析"])
            ),
            CapabilityDefinition(
                ...
                source: .plugin,
                permission: .always,
                metadata: CapabilityMetadata(costLevel: .medium, requiresNetwork: true, isIdempotent: false, typicalUseCases: ["特征对比", "三步法分析"])
            ),
            CapabilityDefinition(
                ...
                metadata: CapabilityMetadata(costLevel: .medium, requiresNetwork: true, isIdempotent: false, typicalUseCases: ["答复书撰写"])
            ),
        ]
    }
}
