        ...
        [
            CapabilityDefinition(
                ...
                metadata: CapabilityMetadata(
                    costLevel: .low, requiresNetwork: true, isIdempotent: true, typicalUseCases: ["特征对比", "侵权分析"])
            ),
            CapabilityDefinition(
                ...
                permission: .always,
                metadata: CapabilityMetadata(
                    costLevel: .medium, requiresNetwork: true, isIdempotent: false, typicalUseCases: ["等同侵权", "等同特征分析"])
            )
        ]
    }
}
