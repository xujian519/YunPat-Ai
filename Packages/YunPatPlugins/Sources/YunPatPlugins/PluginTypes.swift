...
public enum PluginLevel: String, Codable, Sendable { case tool; case feature; case mcpBridge }

public struct PluginManifest: Codable, Sendable {
    public let id: String; public let name: String; public let version: String
    public let minAppVersion: String; public let level: PluginLevel; public let description: String; public let author: String; public let permissions: [PluginPermission]
...
public enum PluginPermission: String, Codable, Sendable { case fileRead; case fileWrite; case networkAPI; case networkArbitrary; case shell; case accessibility; case modelAccess }
public enum PluginState: String, Sendable { case installed; case verified; case loaded; case enabled; case disabled; case failed; case uninstalled }
