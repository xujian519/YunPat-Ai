...
final class PatentLoopEngineTests: XCTestCase {
    func prepareTempVault() -> URL {
        ...
        try? FileManager.default.createDirectory(
            at: dir.appendingPathComponent("Wiki/专利实务"), withIntermediateDirectories: true)
        try? "[[创造性-概述]]".write(to: dir.appendingPathComponent("Wiki/专利实务/index.md"), atomically: true, encoding: .utf8)
        try? "# 创造性概述\n三步法是判断发明创造性的法定框架。".write(
            to: dir.appendingPathComponent("Wiki/创造性-概述.md"), atomically: true, encoding: .utf8)
        return dir
    }
