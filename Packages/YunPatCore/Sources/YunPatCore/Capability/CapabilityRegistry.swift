...
extension CapabilityRegistry {
    public func registerBuiltinCapabilities() {
        ...
        register(capability: CapabilityDefinition(
            ...
            toolNames: ["read_file", "write_file", "list_files", "search_files", "file_undo", "file_operation_history"]))
        register(capability: CapabilityDefinition(
        ...
        register(capability: CapabilityDefinition(
            ...
            metadata: CapabilityMetadata(costLevel: .low, requiresNetwork: true, isIdempotent: true, typicalUseCases: ["专利检索", "对比文件查找"]),
        ...
        register(capability: CapabilityDefinition(
            ...
            metadata: CapabilityMetadata(costLevel: .free, requiresNetwork: false, isIdempotent: true, typicalUseCases: ["能力查询"]),
